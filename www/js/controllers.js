angular.module('babyfood.controllers', ['ionic', 'babyfood.services'])
...
.controller('DiscoverCtrl', function($scope, $timeout, User) {
  ...
  // fired when skip/favorites button is clicked
  $scope.sendFeedback = function(bool) {
    if (bool) {
      User.addProductToFavorites($scope.currentProduct);
    }
    ...
    $timeout(function() {
      // Select one random product for next
...
.controller('FavoritesCtrl', function($scope, User) {
  // get the list of favorites from user favorites
